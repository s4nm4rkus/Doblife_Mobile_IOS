...
import { setBrgyID, setCityID, setProvinceID, setSortBy } from '../../../../features/teamsFilter/teamsFilterSlice';
  ...
  const renderIcon = () => {
    return (
      <View style={styles.iconWrapper}>
        <FontAwesomeIcon icon={faChevronDown} style={styles.chevronDownIcon} size={hp(1.8)}/>
      </View>
    );
  }
