        ...
        <MenuProvider>
          ...
          <ScrollView>
            <View style={styles.inputsContainer}>
              ...
              <View style={styles.inputContainer}>
                <Text style={styles.inputLabelText}>By Date</Text>
                <TouchableOpacity onPress={() => setIsDateOpened(true)}>
                  <View style={styles.popoverContainer}>
                    <Text
                      style={
                        date
                    ...
                    >
                      {date ? moment(date).format("MM/DD/YYYY") : "Pick Date"}
                    </Text>
                    <View style={styles.iconWrapper}>
                      <FontAwesomeIcon
                        icon={faChevronDown}
                ...
                {isDateOpened && (
                  <DatePicker
                    mode="date"
                    value={date || new Date()} // Provide a default value
                    onChange={(event, selectedDate) => {
                      setIsDateOpened(false); // Close the picker after selection
                      if (event.type === "set") {
                        setDate(selectedDate || date); // Update the date
                      }
                    }}
                    display="spinner" // Use 'spinner' or 'calendar' as needed
                  />
                )}
              </View>
