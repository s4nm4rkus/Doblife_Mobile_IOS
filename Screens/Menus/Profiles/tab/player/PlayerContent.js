      ...
      <View style={styles.playerButtonsContainer}>
        <TouchableOpacity onPress={() => setActiveTab("stats")}>
          <Text
            style={[
              ...
              styles.playerActiveButtonText("stats", activeTab),
            ]}
          >
            STATS
          </Text>
        ...
        <TouchableOpacity onPress={() => setActiveTab("information")}>
          <Text
            style={[
              styles.playerButtonText,
              styles.playerActiveButtonText("information", activeTab),
            ]}
          >
            INFORMATION
          </Text>
        ...
        <TouchableOpacity onPress={() => setActiveTab("teams")}>
          <Text
            style={[
              styles.playerButtonText,
              styles.playerActiveButtonText("teams", activeTab),
            ]}
          >
            TEAMS
          </Text>
        ...
        <TouchableOpacity onPress={() => setActiveTab("matches")}>
          <Text
            style={[
              styles.playerButtonText,
              styles.playerActiveButtonText("matches", activeTab),
            ]}
          >
            HISTORY
          </Text>
