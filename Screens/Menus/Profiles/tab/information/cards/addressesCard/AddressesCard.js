...
const AddressesCard = ({ navigation }) => {
  ...
  const handleEditLivingAddress = () => {
    ...
    if (profile.living_address) {
      dispatch(
        setCountry(profile.living_address_barangay.city.province.countryID)
      );
  ...
  const handleEditVotingAddress = () => {
    ...
    if (profile.voting_address) {
      dispatch(
        setCountry(profile.voting_address_barangay.city.province.countryID)
      );
          ...
          >
            <View>
              ...
              >
                {profile.birthplace_city == null
                  ? "no birthplace"
                  : profile.birthplace_city.city}
              </Text>
            </View>
            <View>
              <View style={styles.editContainer}>
                <TouchableOpacity onPress={() => handleEditBirthplace()}>
          ...
          >
            <View>
              ...
              >
                {profile.hometown_city == null
                  ? "no hometown"
                  : profile.hometown_city.city}
              </Text>
            </View>
            <View>
              <View style={styles.editContainer}>
                <TouchableOpacity onPress={() => handleEditHometown()}>
                  <Text style={styles.editText}>Edit</Text>
                </TouchableOpacity>
              </View>
            </View>
        ...
        <View style={styles.details}>
          ...
          >
            <View>
              ...
              <Text
                style={
                  profile.living_address_barangay == null
                    ? styles.nullDetailsText
                    : styles.detailsText
                }
              >
                {profile.living_address_barangay == null
                  ? "no living address"
                  : profile.living_address_barangay.name}
              </Text>
            </View>
            <View>
              <View style={styles.editContainer}>
                <TouchableOpacity onPress={() => handleEditLivingAddress()}>
                  <Text style={styles.editText}>Edit</Text>
                </TouchableOpacity>
              </View>
            </View>
        ...
        <View style={{ marginTop: 12 }}>
          ...
          >
            <View>
              ...
              <Text
                style={
                  profile.voting_address_barangay == null
                    ? styles.nullDetailsText
                    : styles.detailsText
                }
              >
                {profile.voting_address_barangay == null
                  ? "no voting address"
                  : profile.voting_address_barangay.name}
              </Text>
            </View>
            <View>
              <View style={styles.editContainer}>
                <TouchableOpacity onPress={() => handleEditVotingAddress()}>
                  <Text style={styles.editText}>Edit</Text>
                </TouchableOpacity>
              </View>
            </View>
