    ...
    <View style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.details}>
          ...
          <Text 
            style={(profile.gender == null) ? styles.nullDetailsText : styles.detailsText}
          >
        ...
        <View style={styles.details}>
          ...
          <Text 
            style={(profile.birthday == null) ? styles.nullDetailsText : styles.detailsText}
          >
        ...
        <View style={{marginTop: 12}}>
          ...
          <Text 
            style={(age == 0) ? styles.nullDetailsText : styles.detailsText}
          >
            {age == 0 ? '--' : age}
          </Text>
        </View>
